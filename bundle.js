...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fetchReducer = __webpack_require__(180);

	var _fetchReducer2 = _interopRequireDefault(_fetchReducer);

	var _reactThunk = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react-thunk\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var _reactThunk2 = _interopRequireDefault(_reactThunk);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _redux.createStore)(_fetchReducer2.default, (0, _redux.applyMiddleWare)(_reactThunk2.default));
	...
	var fetchReducer = function fetchReducer() {
		...
		switch (type) {
			case "FETCH_DATA_START":
				return Object.assign({}, state, { status: "获取数据中..." });
			// return {...state,{status:"获取数据中..."}}
			case "FETCH_DATA_FINISH":
				return Object.assign({}, state, { status: "获取数据完..." }, list);
			default:
				return state;
		}
	};
